    ...
    <div class="card-header by-3 anog">
        ...
        <nav>
            <ul>
                ...
                <li class="curent"><a href="#">WITHDRAWAL TRANSACTION</a></li>
            </ul>
        </nav>
    </div>
    <div class="card-body">
        ...
        <?php
            $Ql =$_SESSION['Username'];
            $query = "SELECT * FROM wrc888fal WHERE fal70yae='$Ql'";
            $query_run = mysqli_query($conn, $query);
                ...
                <?php
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                        while($row = mysqli_fetch_assoc($query_run))
                        {
                            ?>
                        <tr>
                            <td><?php echo $row['wrcwana']; ?></td>
                            <td><?php echo $row['wrctid']; ?></td>
                            <td><?php echo 'NGN'; echo $row['amo973fal']; ?></td>
                            <td><?php echo $row['depowrc']; ?></td>
                            <td><?php echo $row['yny21fal']; ?></td>
                        </tr>
                        <?php
                        }
